...
<body>
	...
	<div class="container">
	<div class="table_responsive login">
	<form method="post" action="<?php echo base_url('admin/verify');?>">
		<table class="table">
		<?php if(isset($error)){ ?><div class="alert alert-danger">
						<a href="<?php echo base_url('admin/login'); ?>" class="close" data-dismiss="alert" aria-label="close">&times;</a>
						<strong><?php echo $error;?></strong>
					</div><?php } ?>
		<tr><th colspan="2"><h2>Admin Login</h2></th></tr>
